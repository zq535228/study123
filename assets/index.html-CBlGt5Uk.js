import{_ as n,c as i,b as a,o as l}from"./app-BCdWqFPP.js";const e={};function p(t,s){return l(),i("div",null,s[0]||(s[0]=[a(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言"><span>前言</span></a></h2><p>本文主要介绍在Blazor项目中使用FreeSql实现一个简单的登录认证服务。通过这个示例，我们可以了解FreeSql的基本配置和使用方法，以及如何在Blazor中实现用户认证功能。</p><h2 id="主要内容" tabindex="-1"><a class="header-anchor" href="#主要内容"><span>主要内容</span></a></h2><h3 id="_1-freesql配置" tabindex="-1"><a class="header-anchor" href="#_1-freesql配置"><span>1. FreeSql配置</span></a></h3><p>在服务初始化时，我们通过FreeSqlBuilder配置了数据库连接：</p><div class="language-csharp line-numbers-mode" data-highlighter="shiki" data-ext="csharp" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">_fsql</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> =</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676;"> new</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994;"> FreeSql</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">.</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994;">FreeSqlBuilder</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">()</span></span>
